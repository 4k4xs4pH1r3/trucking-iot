...
/*
import com.orendainx.trucking.storm.topologies.NiFiToNiFi
...
/*
  ...
  def deploy = Action {
    ...
    //stormConfig.put("storm.zookeeper.servers", "10.47.10.10")
    import scala.collection.JavaConversions._
    import scala.collection.JavaConverters._
    //stormConfig.put("nimbus.seeds", List("10.47.10.10").asJava)
    stormConfig.put(Config.NIMBUS_SEEDS, "10.47.10.10")
    stormConfig.put(Config.NIMBUS_THRIFT_PORT, 6627)
    stormConfig.put(Config.STORM_ZOOKEEPER_SERVERS, "10.47.10.10")
    ...
    //stormConf2.put("nimbus.host", "10.47.10.10")
    ...
    //val nimbusClient = new NimbusClient(stormConfig, "10.47.10.10", 6627)
    //val nimbusClient = NimbusClient.getConfiguredClient(stormConf2)
    val nimbusClient = new NimbusClient(
      new util.HashMap[String,String](), "10.47.10.10", 6627
    )
